...
public interface ContentRepository extends JpaRepository<BaseContent, String> {
    ...
    Page<BaseContent> findByStateAndContentOrigin(Pageable pageable, String state,String origin);
    Page<BaseContent> findByStateAndContentOriginIsNull(Pageable pageable, String state);
    ...
    List<BaseContent> countContent(@Param("ids") List<String> ids,@Param("name") String name);

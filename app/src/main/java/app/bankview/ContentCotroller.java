...
public class ContentCotroller {
    ...
    public String index(HttpServletRequest request) {
        ...
        if (!StringUtils.isEmpty(id)) {
            ...
            for (String tagId:tags){
               Tags tags1= tagRepository.findOne(tagId);
                if (tags1 != null&&tags1.isState()==false) {
                    tagsList.add(tags1);
                }
            }
    ...
    @ResponseBody
    public String getRecommend(HttpServletRequest request ,@Param("origin") String origin) {
        ...
        Page<BaseContent> list = null;
        if (StringUtils.isEmpty(origin)){
            list = contentRepository.findByStateAndContentOriginIsNull(pageable, "t");
        }else {
            list = contentRepository.findByStateAndContentOrigin(pageable, "t",origin);
        }
    ...
    public String addContent(HttpServletRequest request) throws IOException {
        ...
        c.setState("t");
        c.setPublisherId(request.getSession().getAttribute("userId").toString());
